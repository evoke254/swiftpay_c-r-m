                        ...
                        <tbody> 
                            <tr v-for="(quotedInvoicedProduct, key) in quotedInvoicedProducts" class="element text-center">
                                ...
                                <td>
                                    ...
                                    >
                                    <input type="hidden" class="form-control border border-light" 
                                            v-model="quotedInvoicedProduct['prevQuantity']"
                                    >
                                </td>
...
import { ModelSelect } from 'vue-search-select';
  export default {
    ...
    mounted() {
        ...
        this.quoteData[0]['Invoice_Subject'] = this.requestparams['showModuleData'][0]['Invoice_Subject'];
        ...
        this.quotedInvoicedProducts.forEach((value, index) => {
            this.quotedInvoicedProducts[index]['prevQuantity'] = this.quotedInvoicedProducts[index]['quantity'];
        });
        ...
        this.quoteData[0]['Invoice_Stage']['value'] = this.requestparams['showModuleData'][0]['get_quote_stage']['id'];
        this.quoteData[0]['Invoice_Stage']['text'] = this.requestparams['showModuleData'][0]['get_quote_stage']['name'];
    },
    data () {
      return {
            Quote:'',
    ...
    itemsamnt(){
     ...
     formSubmit(e) {
        e.preventDefault();
          axios.post('/invoicesUpdate/'+this.requestparams['showModuleData'][0]['id'], {
