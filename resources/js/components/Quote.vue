    ...
    <div class="content">
        <div class="row d-flex justify-content-center">
          <div class="col-md-12 text-center">
            <h4>Generate a {{requestparams.name}} </h4>
          </div>
        </div>
                ...
                <div v-for="(column, column_name) in requestparams.columns" class="col-md-6">
                    <div v-for="(display_label, column_type) in column" class="form-group row mb-5">
                        ...
                        <div class="col">
                            ...
                            <input  v-else-if="((column_type == 'bigint') && (display_label == 'Quote' || display_label == 'Invoice'))" type="text" class="form-control border border-light" disabled="" v-model="Invoice">
